...
$("#alternative-page-datatable").DataTable({pagingType:"full_numbers", language: espanol}),
...
$("#row-callback-datatable").DataTable({createdRow:function(a,e,t){15e4<+e[5].replace(/[\$,]/g,"")&&$("td",a).eq(5).addClass("text-danger")}}),
...
$("#fixed-header-datatable").DataTable({responsive:!0}),a.buttons().container().appendTo("#datatable-buttons_wrapper .col-md-6:eq(0)"),
